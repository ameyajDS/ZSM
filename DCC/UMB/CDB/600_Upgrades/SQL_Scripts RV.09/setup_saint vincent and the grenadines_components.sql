...
/* ==================================================================================
    	Source File		:	setup_saint vincent and the grenadines_components.sql
	...
	==================================================================================
		Usage Notes
	----------------------------------------------------------------------------------
		Level 1 Address Components of Saint Vincent and the Grenadines are set-up
	==================================================================================
		Revision History
	----------------------------------------------------------------------------------
...
FROM	countries
WHERE	country_nm	=	'Saint Vincent and the Grenadines';

IF (@@ROWCOUNT = 0)
BEGIN
	RAISERROR ('Country Saint Vincent and the Grenadines not found', 16, 1);
	RETURN;
END
...
INSERT INTO @tbl VALUES ('Charlotte'            ,	     'CH');
INSERT INTO @tbl VALUES ('Grenadines'            ,	     'GT');
