...
INSERT	INTO	@ineffective_districts		VALUES	(	154,	'GODHRA'	);
SET @cnt1 = @@ROWCOUNT;
...
INSERT	INTO	@ineffective_l3_components		VALUES	(	225379,	'Tapi'				);
...
INSERT	INTO	@l3_components	VALUES
								(	@d_cd,	'G',	'Gadhada'	),
								(	@d_cd,	'R',	'Ranpur'	),
								(	@d_cd,	'BV',	'Barvala'	);
SET @cnt2 = @@ROWCOUNT;
