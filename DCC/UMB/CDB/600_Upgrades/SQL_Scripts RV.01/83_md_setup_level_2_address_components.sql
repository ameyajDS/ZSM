/* =================================================================================================
	...
	Started On    : Thu Nov 28 15:33 IST 2013
 ...
 ===================================================================================================
                                                                                         Usage Notes
 ---------------------------------------------------------------------------------------------------
		Sets-up the meta-data for CDB..level_2_address_components table
 ===================================================================================================
                                                                                    Revision History
 ---------------------------------------------------------------------------------------------------
 	JL : 09-Dec-2013
...
SET	@entity_nm	=	'CDB Level 2 Address Component';
...
INSERT INTO	md_entities
	...
	VALUES
		(	@entity_nm, 'CDB', 'level_2_address_components', 'level_2_address_component_id', 'level_2_address_component_nm',
...
INSERT INTO	md_entities_references
	...
	VALUES
		(	@entity_id, 'CDB', 'level_3_address_components', 'level_2_address_component_id'	);
...
INSERT INTO	md_entities_references_pk_columns
	...
	VALUES
		(	@entity_reference_id, 'level_3_address_component_id', 1	);
...
INSERT INTO	md_entities_references
		(	entity_id, reference_db, reference_tbl, reference_column	)
	VALUES
		(	@entity_id, 'PDB', 'persons_addresses', 'level_2_address_component_id'	);
SET	@entity_reference_id	=	SCOPE_IDENTITY();
