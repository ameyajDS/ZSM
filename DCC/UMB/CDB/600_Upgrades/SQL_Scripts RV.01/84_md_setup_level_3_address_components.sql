/* =================================================================================================
	...
	Started On    : Thu Nov 28 15:54 IST 2013
 ...
 ===================================================================================================
                                                                                         Usage Notes
 ---------------------------------------------------------------------------------------------------
		Sets-up the meta-data for CDB..level_3_address_components table
 ===================================================================================================
                                                                                    Revision History
 ---------------------------------------------------------------------------------------------------
 	JL : 26-Jun-2014
		* Reference to table level_4_address_components removed.
 	JL : 09-Dec-2013
...
INSERT INTO	md_entities
	...
	VALUES
		(	@entity_nm, 'CDB', 'level_3_address_components', 'level_3_address_component_id', 'level_3_address_component_nm',
...
INSERT INTO	md_entities_references
	...
	VALUES
		(	@entity_id, 'CDB', 'level_4_address_components', 'level_3_address_component_id'	);
...
INSERT INTO	md_entities_references_pk_columns
	...
	VALUES
		(	@entity_reference_id, 'level_4_address_component_id', 1	);
*/
...
INSERT INTO	md_entities_references
		(	entity_id, reference_db, reference_tbl, reference_column	)
	VALUES
		(	@entity_id, 'PDB', 'persons_addresses', 'level_3_address_component_id'	);
SET	@entity_reference_id	=	SCOPE_IDENTITY();
