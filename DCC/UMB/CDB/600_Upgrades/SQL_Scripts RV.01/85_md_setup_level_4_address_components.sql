/* =================================================================================================
	...
	Started On    : Mon Dec 09 17:02 IST 2013
 ...
 ===================================================================================================
                                                                                         Usage Notes
 ---------------------------------------------------------------------------------------------------
		Sets-up the meta-data for CDB..level_4_address_components table
 ===================================================================================================
                                                                                    Revision History
 ---------------------------------------------------------------------------------------------------
 	JL : 26-Jun-2014
		* Level 4 Address Component dropped
 	JL : 09-Dec-2013
		* Initial Version
================================================================================================= */
...
INSERT INTO	md_entities
	...
	VALUES
		(	@entity_nm, 'CDB', 'level_4_address_components', 'level_4_address_component_id', 'level_4_address_component_nm',
...
INSERT INTO	md_entities_references
	...
	VALUES
		(	@entity_id, 'PDB', 'persons_addresses', 'level_4_address_component_id'	);
...
INSERT INTO	md_preceding_entities
	...
	VALUES
		(	@entity_id, 'level_1_address_component_id', 2, 'Level 1 Address Component',
			'CDB', 'level_1_address_components', 'level_1_address_component_id', 'level_1_address_component_nm'
		);
...
INSERT INTO	md_preceding_entities
	...
	VALUES
		(	@entity_id, 'level_2_address_component_id', 3, 'Level 2 Address Component',
			'CDB', 'level_2_address_components', 'level_2_address_component_id', 'level_2_address_component_nm'
		);
...
INSERT INTO	md_preceding_entities
	...
	VALUES
		(	@entity_id, 'level_3_address_component_id', 4, 'Level 3 Address Component',
			'CDB', 'level_3_address_components', 'level_3_address_component_id', 'level_3_address_component_nm'
		);
