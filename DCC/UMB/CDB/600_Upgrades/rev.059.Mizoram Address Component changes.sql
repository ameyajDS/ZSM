...
INSERT	INTO	@ineffective_districts		VALUES	(	402,	'Aizal'			),
													(	405,	'CHHIMTUIPUI'	);
SET @cnt1 = @@ROWCOUNT;
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Hnahthial'	);
SET @cnt1 = @@ROWCOUNT;
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Khawzawl'	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Saitual'	);
SET @cnt1 = @cnt1 + @@ROWCOUNT;
