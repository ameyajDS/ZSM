...
WHERE	level_1_address_component_nm = 'Rajasthan';

INSERT INTO	audit_logs
		(	[session_id], [application_id], [user_no], [user_role_id], [operation], [screen_id], [object_id], [operation_dts], [is_consumed]	)
	VALUES
		(	0, 'Script', 1, 'System', 'I', 'rev066', 'Rajasthan-Address Components', GETDATE(), 0	);
...
INSERT	INTO	@ineffective_districts		VALUES	(	505,	'NAGAUR RAJ'	),
													(	506,	'NIMKATHANA'	),
													(	508,	'PALI MARWAR'	);
SET @cnt1 = @@ROWCOUNT;
