...
INSERT INTO	audit_logs
	...
	VALUES
		(	0, 'Script', 1, 'System', 'I', 'rev071', 'Telangana-Address Components', GETDATE(), 0	);
...
INSERT	INTO	@l2_renames		VALUES	(	52564,	'Hanmakonda',	'Hanamkonda'	);
...
INSERT	INTO	@l3_components	VALUES	(	@d_cd,	'BP',	'Boduppal'		),
										(	@d_cd,	'JN',	'Jawaharnagar'	),
										(	@d_cd,	'TK',	'Thumkunta'		),
										(	@d_cd,	'NR',	'Nagaram'		),
										(	@d_cd,	'KP',	'Kompally'		),
										(	@d_cd,	'PC',	'Pocharam'		),
										(	@d_cd,	'DG',	'Dammaiguda'	),
										(	@d_cd,	'PD',	'Peerzadiguda'	);
SET @cnt2 = @cnt2 + @@ROWCOUNT;

--	==================================================


SET @d_cd = '014';		--	Nalgonda

INSERT	INTO	@l3_components	VALUES	(	@d_cd, 'DK',	'Devarakonda'	);
SET @cnt2 = @cnt2 + @@ROWCOUNT;

--	==================================================


SET @d_cd = '016';		--	Nizamabad
...
SET @d_cd = '018';		--	Rangareddy

INSERT	INTO	@l3_components	(	d_cd, l3_nm	)	VALUES
										(	@d_cd,	'Badangpet'				),
										(	@d_cd,	'Bandlaguda Jagir'		),
										(	@d_cd,	'Meerpet–Jillelguda'	);
SET @cnt2 = @cnt2 + @@ROWCOUNT;
...
INSERT	INTO	@l3_components	VALUES	(	@d_cd,	'ZB',	'Zahirabad'      	);
SET @cnt2 = @cnt2 + @@ROWCOUNT;
