...
INSERT	INTO	@l2_renames		VALUES	(	388,	'IMPHAL',	'IMPHAL EAST'	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Kangpokpi' 	);
...
INSERT	INTO	@l3_components	(	d_cd, l3_nm	)	VALUES
										...
										(	@d_cd,	'Champhai'        	),
										(	@d_cd,	'Saikul'          	),
										(	@d_cd,	'Saitu Gamphazol' 	),
										(	@d_cd,	'Tujang Waichong' 	),
										(	@d_cd,	'Kangchup Geljang'	),
										(	@d_cd,	'Bungte Chiru'    	),
										(	@d_cd,	'Island'          	),
										(	@d_cd,	'Lhungtin'        	);
SET @cnt2 = @@ROWCOUNT;
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Tengnoupal'	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Pherzawl'  	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Noney'   );
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Kamjong'   	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Jiribam'   	);
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Kakching'  	);
