...
INSERT INTO	audit_logs
	...
	VALUES
		(	0, 'Script', 1, 'System', 'I', 'rev055', 'Madhya Pradesh-Address Components', GETDATE(), 0	);
...
INSERT	INTO	@l2_renames		VALUES	(	315,	'HOSHANGABAD',	'Narmadapuram'	);
...
INSERT	INTO	@l3_renames		VALUES	(	96021,	'HOSHANGABAD',		'Narmadapuram'			),
										(	96022,	'HOSHANGABAD CITY',	'Narmadapuram City'		);
...
INSERT	INTO	@ineffective_districts		VALUES	(	296,	'ANUP NAGAR'	),
													(	322,	'LASHKAR'		),
													(	325,	'MORAR'			);
SET @cnt1 = @@ROWCOUNT;
...
INSERT	INTO	@districts		VALUES	(	@d_cd,	'Niwari'	);
SET @cnt1 = @@ROWCOUNT;
