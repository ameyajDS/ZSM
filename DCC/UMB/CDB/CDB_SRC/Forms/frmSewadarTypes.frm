...
Begin VB.Form frmSewadarTypes 
   ...
   Begin VB.Frame fraSewadarTypes 
      BackColor       =   &H00C0C0C0&
      BorderStyle     =   0  'None
      Height          =   9165
      Left            =   0
      ...
      Top             =   0
      Width           =   12915
      Begin FPSpread.vaSpread sprSewadarTypes 
         Height          =   5925
         Left            =   360
         TabIndex        =   1
         Top             =   360
         ...
         SpreadDesigner  =   "frmSewadarTypes.frx":0000
      End
   End
End
Attribute VB_Name = "frmSewadarTypes"
...
Dim WithEvents sprSewadarTypesController As clsSpreadController
Attribute sprSewadarTypesController.VB_VarHelpID = -1

'This enum holds all the column numbers of the spread controller 'sprSewadarTypesController' that
...
Private Enum sewadarTypesColumns
    Name = 1
    txn_ts = 2
    effectivefrom = 3
    effectiveTill = 4
...
On Error GoTo errortag
    ...
    If Not sprSewadarTypesController.prepareSpreadForSave Then
        Exit Sub
    End If
    ...
    saveData = False
    strDeleteTemplate = "CDB..delSewadarTypes " & "@@, @@"
    strUpdateTemplate = "CDB..updSewadarTypes " & "@@, @@, @@, @@, @@"
    strInsertTemplate = "CDB..insSewadarTypes " & "@@, @@, @@"
    
    dbManager.beginTrans
    Dim i As Long
    Dim sqlStrings() As String
    If sprSewadarTypesController.getNumberOfRowsForState(DELETED_STATE) <> 0 Then
         
        sqlStrings = sprSewadarTypesController.getDeleteStrings(strDeleteTemplate, _
                                                                      "Yes", _
                                                                      "No ", _
                                                                      sewadarTypesColumns.ID, _
                                                                      sewadarTypesColumns.txn_ts)
        ...
        Next i
    End If
    If sprSewadarTypesController.getNumberOfRowsForState(UPDATED_STATE) <> 0 Then
         sqlStrings = sprSewadarTypesController.getUpdateStrings(strUpdateTemplate, _
                                                                      "Yes", _
                                                                      "No ", _
                                                                      sewadarTypesColumns.ID, _
                                                                      sewadarTypesColumns.Name, _
                                                                      sewadarTypesColumns.effectivefrom, _
                                                                      sewadarTypesColumns.effectiveTill, _
                                                                      sewadarTypesColumns.txn_ts)
        ...
        Next i
    End If
    If sprSewadarTypesController.getNumberOfRowsForState(NEW_STATE) <> 0 Then
         sqlStrings = sprSewadarTypesController.getInsertStrings(strInsertTemplate, _
                                                                      "Yes", _
                                                                      "No ", _
                                                                      sewadarTypesColumns.Name, _
                                                                      sewadarTypesColumns.effectivefrom, _
                                                                      sewadarTypesColumns.effectiveTill)
...
'retrieve the existing records of skills to the spread controller "sprSewadarTypesController"
Private Sub retrieveSewadarTypes()
On Error GoTo errortag
    Dim strSQL As String
    strSQL = "SELECT sewadartype_nm, Cast(txn_ts As BigInt), Convert(varchar, effective_from, 106)effective_from, " & _
             "Convert(varchar,effective_till,106)effective_till, sewadartype_id " & _
             "From CDB..sewadar_types"
    sprSewadarTypesController.retrieveRecords strSQL
Exit Sub
...
Public Function clsWindowInterface_getScreenID() As String
    clsWindowInterface_getScreenID = "PER_10"
End Function
...
Private Sub setSpreadController()
    ...
    'initializing and adding columns to sprSewadarTypesController of skills
    Set sprSewadarTypesController = New clsSpreadController
    sprSewadarTypesController.registerSpreadInstance uiManager, sprSewadarTypes, TABULAR_SPREAD, Me
    sprSewadarTypesController.setHeaderHeight 500
    
    sprSewadarTypesController.addColumn "Sewadar Type", 60, edit_CELL_TYPE, True, True, , , , 20
    sprSewadarTypesController.addColumn "Txn Ts", 0, STATIC_TEXT_CELL_TYPE, NON_EDITABLE_COLUMN, NON_MANDATORY_COLUMN
    sprSewadarTypesController.addColumn "Effective From", 15, DATE_CELL_TYPE, True, True, , , , , CENTER_ALIGNMENT
    sprSewadarTypesController.addColumn "Effective Till", 15, DATE_CELL_TYPE, True, True, , , , , CENTER_ALIGNMENT
    sprSewadarTypesController.addColumn "ID", 9, STATIC_TEXT_CELL_TYPE, False, False, , , , , RIGHT_ALIGNMENT
...
Private Sub setEnableDisableControls(p_intMode As Integer)
    Select Case p_intMode
        Case uiManager.TABULAR_MODE
            sprSewadarTypesController.setSpreadModeForTabularSpread p_intMode
        Case uiManager.NEW_MODE
            sprSewadarTypesController.setSpreadModeForTabularSpread p_intMode
    End Select
End Sub

Private Sub sprSewadarTypesController_setDefaultValues(ByVal p_lonRow As Long)
    sprSewadarTypesController.setTextOfCell p_lonRow, sewadarTypesColumns.effectivefrom, Format(Date, "dd mmm yyyy")
    sprSewadarTypesController.setTextOfCell p_lonRow, sewadarTypesColumns.effectiveTill, "31 Dec 9999"
End Sub
...
Private Sub sprSewadarTypesController_ValidateCell(ByVal p_lonRow As Long, _
...
On Error GoTo errortag
    ...
    varEffectiveFrom = sprSewadarTypesController.getTextOfCell(p_lonRow, sewadarTypesColumns.effectivefrom)
    varEffectivetill = sprSewadarTypesController.getTextOfCell(p_lonRow, sewadarTypesColumns.effectiveTill)
    
    Select Case p_lonColumn
        Case sewadarTypesColumns.effectiveTill
        ...
        Case sewadarTypesColumns.effectivefrom
        ...
        Case sewadarTypesColumns.Name
            If Trim(sprSewadarTypesController.getTextOfCell(p_lonRow, p_lonColumn)) = "" Then
                sprSewadarTypesController.setTextOfCell p_lonRow, p_lonColumn, ""
            End If
...
errortag:
    errorManager.setErrorAttributes modStandardMessages.UnknownError, "sprSewadarTypesController_ValidateCell", "", ERROR_TYPE, Me.clsWindowInterface_getScreenID, Me.clsWindowInterface_getMode
    Err.Raise Err.Number
End Sub


Private Sub sprSewadarTypesController_ValidateRow(ByVal p_lonRow As Long, p_bolIsRowValid As Boolean)
    Dim varEffectiveFrom As Variant
    Dim varEffectivetill As Variant
    ...
    If sprSewadarTypesController.isCellValueRepeatedInColumn(utils.createLongArray(sewadarTypesColumns.Name), p_lonRow, True) Then
