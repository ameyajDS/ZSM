...
{
    public class OccupationsLookup : BaseCDBMasterLookup
    {

        public OccupationsLookup()
            : base()
        {
        ...
        public override void OnLookupDialogShowing(object sender, LookupEventArgs e)
        {
            ...
            e.LookupSqlString += " ORDER BY occupation_nm";

        }
        
        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OccupationsLookup));
            this.SuspendLayout();
            // 
            // OccupationsLookup
            // 
