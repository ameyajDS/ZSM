...
{
    public class SewadarTypesLookup : BaseCDBMasterLookup
    {


        public SewadarTypesLookup()
            : base()
        {
        ...
        public override void OnLookupDialogShowing(object sender, LookupEventArgs e)
        {
            ...
            e.LookupSqlString += " ORDER BY sewadartype_nm";
        }
        
        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SewadarTypesLookup));
            this.SuspendLayout();
            // 
            // SewadarTypesLookup
            // 
            ...
            this.Name = "SewadarTypesLookup";
            this.Title = "SewadarTypes";
