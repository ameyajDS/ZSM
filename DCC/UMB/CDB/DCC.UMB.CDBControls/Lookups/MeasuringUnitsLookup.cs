...
{
    public class MeasuringUnitsLookup : BaseCDBMasterLookup
    {

        public MeasuringUnitsLookup()
            : base()
        {
        ...
        public override void OnLookupDialogShowing(object sender, LookupEventArgs e)
        {
            ...
            e.LookupSqlString += " ORDER BY measuring_unit_nm";

        }
        
        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MeasuringUnitsLookup));
            this.SuspendLayout();
            // 
            // MeasuringUnitsLookup
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 14F);
            this.LookupColumns = resources.GetString("$this.LookupColumns");
            this.Name = "MeasuringUnitsLookup";
            this.Title = "MeasuringUnits";
