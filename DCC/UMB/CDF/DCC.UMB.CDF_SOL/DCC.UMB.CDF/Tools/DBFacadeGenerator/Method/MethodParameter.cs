...
namespace DCC.UMB.CDF.Tools.DBFacadeGenerator.Method
{
    class MethodParameter
    {
        ...
        public override string ToString()
        {
            ...
            string parameterType = type.IsValueType && this.paramDirection == "IN" ? type.ToString().Replace("System.", "") + "?" : type.ToString().Replace("System.", "");
        ...
        public string GetSafeParameterName()
        {
            ...
            lstKeywords.AddRange(this.cSharpKeywords);
            if(lstKeywords.Contains(this.name))
            {
                return this.name + "_";
            }
            else
