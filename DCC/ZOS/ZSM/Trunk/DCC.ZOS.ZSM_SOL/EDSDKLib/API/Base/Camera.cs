...
namespace EOSDigital.API
{
    ...
    public class Camera : IDisposable
    {
        ...
        {
            if (camRef == IntPtr.Zero) throw new ArgumentNullException(camRef.ToString());
            CamRef = camRef;
        ...
        {
            CheckState();
            if (Info == null) throw new ArgumentNullException(Info.ToString());
        ...
        {
            if (IsDisposed) throw new ObjectDisposedException(ID.ToString());
