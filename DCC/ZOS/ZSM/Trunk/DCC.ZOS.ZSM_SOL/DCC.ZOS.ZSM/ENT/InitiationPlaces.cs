...
{
    public partial class InitiationPlaces : CDBAbstractScreen
    {
        public InitiationPlaces()
        {
            InitializeComponent();
        }
        ...
        public override string ScreenId
        {
            ...
            {
                // Screen ID goes here
                return Screens.ENT_INITIATION_PLACES;
            }
        }
        ...
        public override void ShowScreen(UIModes uiMode, string screenParameters)
        {
            ...
            {
                ClearControls();
                this.intPlaceID.ReadOnly = false;
            }
        ...
        public override void LoadBrowseView(int rowIndex)
        {
            ...
            this.ObjectIdForLogOperation = this.intPlaceID.DisplayText;
        }


        public override DCCSqlDataReader GetQueryModeRetrivalResults()
        {
            ViewInitiationPlaceSQLSelectQuery query = new ViewInitiationPlaceSQLSelectQuery();

            //This line avoids the if condition and specifies that place_id is a primary/indexed key.
            query.place_id.IsExcluisive = true;
            ...
            query.place_id.Between(this.intPlaceID);
            //]]

            query.place_nm.Contains(this.txtPlaceName.DisplayText);
        ...
        public override void CreateData()
        {
            ...
            this.dbFacade.InsertInitiationPlace(ref generatedId,
        ...
        public override void UpdateData()
        {
            ...
            this.dbFacade.UpdateInitiationPlace((short)this.intPlaceID.DisplayTextAsInteger.Value, 
                                                this.txtPlaceName.DisplayText,                             
                                                txn_ts,
                                                this.dtmEffectiveRange.FromDate,
                                                this.dtmEffectiveRange.ToDate
        ...
        public override void DeleteData()
        {
            ...
            this.dbFacade.DeleteInitiationPlace((short)this.intPlaceID.DisplayTextAsInteger.Value,
                                                txn_ts                                                
                                                );
        }
