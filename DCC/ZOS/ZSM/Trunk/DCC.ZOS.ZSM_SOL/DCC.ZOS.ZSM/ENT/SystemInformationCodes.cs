...
namespace DCC.ZOS.ZSM.ENT
{
    public partial class SystemInformationCodes : ZSMAbstractScreen
    {
        ...
        {
            ViewSystemInformationCodeSQLSelectQuery query = new ViewSystemInformationCodeSQLSelectQuery();
        ...
        public override void LoadBrowseView(int rowIndex)
        {
            ...
            string strSysInfCode = this.grdList.AsStr(grdListColNames.old_info_cd.ToString());
        ...
        {
            DataSet dset;
            dset = this.dbFacade.QuerySystemInformationValue(strSysInfCode);
        ...
        public override void UpdateData()
        {
            try
            {
                ...
                {
                    string info_value = rv.AsStr(grdSystemInfoValuesColNames.grd_info_value.ToString());
        ...
        {
            this.dbFacade.InsertSystemInformationCode(this.txtCode.DisplayText,
        ...
        {
            string oldInfoCode = this.grdList.AsStr(grdListColNames.old_info_cd.ToString());
            this.dbFacade.DeleteSystemInformationCode(oldInfoCode);
        }
        ...
        private List<string> SaveSysInfValuesGridAsTask(string stroldInfoCode)
        {
            ...
            try
            {
                ...
                if (this.grdSystemInfoValues.Rows.Count > 0)
                {
                    ...
                    allTasks = this.grdSystemInfoValues.GetAllDBTasks(this.dbFacade, "DeleteSystemInformationValueAsTask", "UpdateSystemInformationValueAsTask", "InsertSystemInformationValueAsTask", overiddingParamValues, string.Empty, string.Empty, string.Empty);
