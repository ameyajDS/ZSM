/* ==================================================================================
    Source File		:	setup_combined_teams_wo_list.sql
...
SET	@centre_id	=	7210;		--- Nagpur
SET @sewa_id	=	110000001;
Select * from sewas where sewa_id = @sewa_id;
