/* ==================================================================================
    Source File		:	upgrade_v5.49.sql
    Author(s)		:	Jitendra Loyal
    Started On		:	Thu Feb 24 2012
    ...
    ==================================================================================
																		   Usage Notes
    ----------------------------------------------------------------------------------
		Upgrade Script for v5.44
			..... SysAdmin..SetPackageScreen has been modified to support only menu items insertions (without a screen).
    ==================================================================================
								      								  Revision History
    ----------------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN
		RAISERROR ('ERROR: List of User Roles along with Operations must be specified [%s] or Operations must be specified for menu [%s]', 16, -1, @p_screen_id, @p_menu_dsc);
		RETURN
	END
	...
	BEGIN
		RAISERROR ('ERROR: User Role ID along with Operations Supported must be specified for Screen [%s] or only Operations must be specified for Menu [%s]', 16, -1, @p_screen_id, @p_menu_dsc);
		RETURN
	END
