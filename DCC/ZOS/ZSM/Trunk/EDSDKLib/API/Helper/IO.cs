...
namespace EOSDigital.API
{
    ...
    public class DownloadInfo
    {
        ...
        {
            if (inRef == IntPtr.Zero) throw new ArgumentNullException(inRef.ToString());
    ...
    public class SDKStream : Stream
    {
        ...
        {
            if (sdkStream == IntPtr.Zero) throw new ArgumentNullException(sdkStream.ToString());
            Reference = sdkStream;
        }
        ...
        {
            if (buffer == IntPtr.Zero) throw new ArgumentNullException("");
